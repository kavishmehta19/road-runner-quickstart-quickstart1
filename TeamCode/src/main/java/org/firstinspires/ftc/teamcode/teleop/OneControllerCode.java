...
@TeleOp(name="One Controller Code")
public class OneControllerCode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            boolean leftBumper = g1.left_bumper;
            ...
            boolean triggers = g1.right_trigger > 0.8 && g1.left_trigger > 0.8;
